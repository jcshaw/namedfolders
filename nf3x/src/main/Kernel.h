...
//NF-catalogs operations
	...
	//InsertCatalog support recreation whole catalog hierarchy, i.e. "a/b/c/d/"
	bool InsertCatalog(tstring const& srcCatalog, tstring const& subCatalogName);
	inline bool InsertCatalog(tstring const& srcCatalog) { 
		return InsertCatalog(srcCatalog, L"");
	}
