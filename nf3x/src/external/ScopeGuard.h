...
//see http://support.microsoft.com/kb/199057
//We get smth like (__LINE__Var+15) instead of line number

#define ON_BLOCK_EXIT Ext::ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) = Ext::MakeGuard
#define ON_BLOCK_EXIT_OBJ Ext::ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) = Ext::MakeObjGuard
