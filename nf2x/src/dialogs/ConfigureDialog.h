...
//NamedFolders 2x Configure Dialog
/* Основные настройки */
...
//			<< &far_di_button(ID_ADVANCED, lg::MSG_ADVANCED, 35, 13)
			...
			<< &far_di_edit(ID_EDIT_MASKS_SOFT_EXCEPTIONS, left_half, 16, right-1, "")
			...
			<< &far_di_edit(ID_EDIT_PANELWIDTH, left_half+16, 14, right-1, "")
			<< &far_di_text(ID_TEXT_PANELWIDTH, lg::CFG_TEXT_PANELWIDTH, left_half, 14, left_half+16)

			<< &far_di_edit(ID_EDIT_PREFIX, left+20, 14, left_half-2, "")
			...
			<< &far_di_edit(ID_EDIT_ASTERIXMODE, left_half+25, 9, right-1, "")
			...
			<< &far_di_edit(ID_EDIT_MENU_DISK_FAST_KEY, left, 3, left+1, "")
