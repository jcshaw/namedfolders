...
//сохран€ем данные в реестре в OEM кодировке
//¬нимание: внутри программы строки хран€тьс€ в виде Ansi
...
extern TCHAR const * SLASH_CATS;		//разделитель каталогов
extern TCHAR const * SLASH_DIRS;		//разделитель директорий
extern TCHAR const SLASH_CATS_CHAR;		//разделитель каталогов
extern TCHAR const SLASH_DIRS_CHAR;		//разделитель директорий
...
extern const TCHAR CHAR_LEADING_VALUE_ENVVAR;	//символ дл€ идентификации переменных среды в пут€х
extern const TCHAR CHAR_LEADING_VALUE_REGKEY;	//символ дл€ идентификации ключей реестра в пут€х 
